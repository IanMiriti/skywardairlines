...
// Mock offers data with updated airline name
const mockOffers = [
  {
    id: 1,
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="container">
        ...
        <div className="bg-skyward-primary rounded-xl overflow-hidden relative mb-12 animate-fade-in">
          ...
          <div className="relative z-10 p-6 md:p-12 text-white">
            <div className="max-w-2xl">
              <Tag className="mb-4 text-skyward-secondary" size={32} />
        ...
        <h2 className="text-2xl font-bold mb-6 text-skyward-dark">Current Offers</h2>
            ...
            {offers.map((offer, index) => (
              ...
              >
                <div className="relative h-48">
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-skyward-secondary text-white py-1 px-3 rounded-full font-semibold text-sm">
                    {offer.discount}
                  </div>
                </div>
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    <Plane size={14} className="text-skyward-primary" />
                    <span className="text-sm text-gray-600">
                      {offer.route.from} to {offer.route.to}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 mb-4">
                    <Calendar size={14} className="text-skyward-primary" />
                    <span className="text-sm text-gray-600">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-lg font-bold text-skyward-primary">
                    ...
                    <div className="text-skyward-secondary flex items-center gap-1 font-medium group">
        ...
        <div className="mt-12 bg-white rounded-lg shadow-sm p-6 animate-fade-in" style={{ animationDelay: '300ms' }}>
          ...
          <ul className="space-y-2 text-gray-600 list-disc pl-5">
            ...
            <li>All bookings are subject to Skyward Airlines's general terms and conditions of carriage.</li>
          </ul>
        </div>
      </div>
    </div>
